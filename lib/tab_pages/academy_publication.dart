...
class AcademyPublication extends StatefulWidget {
  //String url;
  //AcademyPublication({this.url});
  @override
  _AcademyPublicationState createState() => _AcademyPublicationState();
}

class _AcademyPublicationState extends State<AcademyPublication> {
  List <Books> _books;
  bool _loading;
  String url='http://175.107.63.137/LibraryAPP/api/values/BookCategoryList?CategId=17';
