...
class OrientalPage extends StatefulWidget {
  //String url;
  //OrientalPage({this.url});
  @override
  _OrientalPageState createState() => _OrientalPageState();
}

class _OrientalPageState extends State<OrientalPage> {
  List <Books> _books;
  bool _loading;
  String url='http://175.107.63.137/LibraryAPP/api/values/BookCategoryList?CategId=14';
